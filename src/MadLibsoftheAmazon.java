...
public class MadLibsoftheAmazon {
	public static void main(String[] args) {
		...
		String liquid = JOptionPane.showInputDialog("Type in a type of liquid:");
		// Get the user to enter a body part
		String body = JOptionPane.showInputDialog("Type in a body part:");
		// Get the user to enter a verb
		String verb = JOptionPane.showInputDialog("Type in a verb (Present Tense):");
		...
		JOptionPane.showMessageDialog(null,
				"Piranhas are more " + adjective
						+ " during the day, so cross the river at night. Piranhas are addicted to fresh " + liquid
		...
		// "Piranhas are more" + adjective + "during the day, so cross the river
		// at
		// night." "Piranhas are attracted to fresh" + liquid + "and will most
		// likely take a bite out of your" + body + "if you" + verb.
		// Whatever you do, if you have an open wound, try to find another way
		// to get
